        ...
        <div class="container">
            <div class="pitwNoticeTable">
                ...
                <div class="pitwTableBody">
                      @foreach($Doc as $doc)
                    <div class="tableItem">
                        <div class="tablcol heading"><span>{{$doc->name}}</span></div>
                        <div class="tablcol date"><span>২৩ আগস্ট, ২৩</span></div>
                        <div class="tablcol view"><a href="/uploads/{{$doc->file}}" class="viewBtn"><i class="fa fa-eye"></i> দেখুন</a></div>
                        <div class="tablcol download"><a href="/uploads/{{$doc->file}}" class="downloadBtn">ডাউনলোড</a></div>
                    </div>
                    @endforeach
